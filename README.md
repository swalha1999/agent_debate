...
| [`docs/hw2_requirements.pdf`](docs/hw2_requirements.pdf) | The **authoritative HW2 exercise spec** ("Exercise 02 — AI Agent Debate"); the PRD conforms to it (see PRD §11.1 compliance map). |
