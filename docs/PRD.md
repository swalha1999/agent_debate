...
Companion docs:
- `hw2_requirements.pdf` — **the authoritative exercise spec** ("Exercise 02 — AI Agent Debate"); this PRD must conform to it (alongside the lecturer guidelines). Section refs below cite its `§8.x`/`§9` clauses.
...
**Watchdog + keep-alive (HW2 PDF §8.6).** In **addition** to the per-turn
